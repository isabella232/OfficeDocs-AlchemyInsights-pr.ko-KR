...
송장의 상태는 송장 블레이드에서 유료로 업데이트됩니다.

**권장 문서**

- [Microsoft Azure에 대한 청구서 결제 방법](https://docs.microsoft.com/azure/cost-management-billing/understand/pay-bill)
...
- [청구 프로필의 결제 방법 변경](https://docs.microsoft.com/azure/cost-management-billing/manage/change-credit-card?WT.mc_id=Portal-Microsoft_Azure_Support#manage-credit-cards-for-a-microsoft-customer-agreement)
