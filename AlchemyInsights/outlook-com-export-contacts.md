...
.
2. 페이지 맨 위에서 내보내기 **관리** 를 선택 \> **Export**합니다.
3. 모든 대화 상대를 내보낼지, 아니면 특정 폴더의 연락처만 내보내시겠습니까를 선택 하 고 **내보내기**를 선택 합니다.
4. 페이지 맨 아래에서 **저장** 을 선택 하 고 기본 다운로드 폴더에 "contacts.csv"이 저장 됩니다. .Csv 파일을 저장할 위치를 선택 하려면 저장 옆에 있는 화살표를 선택 하 고 다른 **이름으로 저장**을 선택 합니다.
