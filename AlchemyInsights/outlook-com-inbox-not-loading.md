...
1. 페이지 맨 위에서 **빈 폴더** 를 선택 합니다 ( **Empty Focused**  /  **Empty Other** 중요 받은 편지함이 설정 된 경우에는 비어 있습니다.).
1. **모두 삭제**를 선택 합니다.
1. 삭제 된 메시지를 모두 제거 하려면 지운 편지함 [폴더](https://outlook.live.com/mail/deleteditems) 를 열고 **Empty folder**  >  **모두 삭제**를 선택한 다음 페이지 맨 위에 있는 **이 폴더에서 삭제 된 항목 복구** 를 선택 하 고 **빈 폴더** 를 다시 선택 합니다.
