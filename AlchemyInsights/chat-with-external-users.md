...
이러한 차이점을 검토하여 페더에 사용할 수 있는 기능과 추측 액세스에 사용할 수 있는 기능을 이해해야 합니다. 예를 들어 외부 액세스(페더레이션)를 사용하면 채팅 및 현재 상태와 같은 1:1 통신을 허용하지만 페더레이션 사용자는 Teams 없습니다. 외부 사용자가 채널 대화 또는 파일 공유를 Teams 참가하려면 게스트 액세스를 설정해야 합니다. 자세한 내용은 [Manage external access in Microsoft Teams.](/microsoftteams/manage-external-access#external-access-vs-guest-access)
