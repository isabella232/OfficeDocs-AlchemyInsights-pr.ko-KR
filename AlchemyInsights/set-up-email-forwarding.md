...
자세한 내용은 [Configure email 착신 전환 In Microsoft 365](https://docs.microsoft.com/microsoft-365/admin/email/configure-email-forwarding)을 참조 하십시오.
...
직원이 종료 됩니까? 권장 되는 단계를 보려면 [Microsoft 365에서 이전 직원 제거를](https://docs.microsoft.com/microsoft-365/admin/add-users/remove-former-employee) 참조 하세요.