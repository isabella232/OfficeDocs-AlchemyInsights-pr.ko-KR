...
4. Office에 아직 라이선스가 없는 경우 [Office 활성화 상태를 재설정하십시오. 그런 다음 메시지가 표시되면 Office를 다시 시작하고 회사 또는 학교 계정을 사용하여 로그인하세요.  

5. 문제 해결 작업에 대한 자세한 내용은 [Office에서 라이선스가 없는 제품 및 정품 인증 오류](https://support.office.com/article/unlicensed-product-and-activation-errors-in-office-0d23d3c0-c19c-4b2f-9845-5344fedc4380)를 참조하세요.
