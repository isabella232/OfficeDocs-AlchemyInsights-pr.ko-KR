...
조직 데이터를 기반으로 모든 현재 구독이 25 명 미만인 것으로 예상 됩니다. 온라인에서 구독을 취소 하려면 **Billing** \> **[제품](https://go.microsoft.com/fwlink/p/?linkid=842054)** 청구 페이지로 이동 합니다. **& 작업 설정** 섹션에서 **구독 취소**를 선택 합니다.
