...
ms.locfileid: "50708284"
---
# <a name="restore-deleted-items-from-sharepoint"></a>SharePoint에서 삭제된 항목 복원
...
- [삭제된 OneDrive 복원](https://docs.microsoft.com/onedrive/restore-deleted-onedrive)
...
많은 OneDrive 또는 SharePoint 파일이 맬웨어에 의해 삭제, 덮어 사용, 손상 또는 감염되는 경우 파일 복원 기능을 사용하여 이전 시간으로 전체 OneDrive 또는 SharePoint 라이브러리를 복원할 수 있습니다.
