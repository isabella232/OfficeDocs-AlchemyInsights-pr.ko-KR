...
---
# <a name="use-a-property-list-to-configure-the-policy-settings-for-microsoft-edge-on-macos"></a>속성 목록을 사용하여 macOS에서 Microsoft Edge에 대한 정책 설정 구성

macOS에서는 속성 목록 파일(.plist)을 사용하여 Microsoft Edge 버전 77 이상을 구성할 수 있습니다.
