...
---
# <a name="verify-your-domain-with-namecheap"></a>Namecheap을 사용하여 도메인 확인
...
단계별 [지침은 Microsoft 365용 Namecheap에서 DNS](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-namecheap) 레코드 만들기를 참조하세요.