...
3. IP 허용 **목록을 검토합니다.** 안전한 **목록이 사용하도록 설정되어 있는지** 확인합니다.

    > [!NOTE]
    > Microsoft는 신뢰할 수 있는 보낸 사람에 대한 타사 소스를 구독합니다. 수신 **가능 목록이** 사용하도록 설정되어 있는 경우 이러한 신뢰할 수 있는 보낸 사람이 스팸으로 잘못 표시되지 않습니다. 받는 가음성(스팸으로 분류된 좋은 메일)의 수가 줄어들기 때문에 이 옵션을 선택하는 것이 좋습니다.
