...
---
# <a name="automatically-encrypt-certain-office-365-email-messages"></a>특정 Office 365 전자 메일 메시지 자동 암호화
...
암호화 규칙을 만드는 데 대한 자세한 내용은 [Office 365에서](https://docs.microsoft.com/microsoft-365/compliance/define-mail-flow-rules-to-encrypt-email)전자 메일 메시지를 암호화하는 메일 흐름 규칙 정의를 참조하세요.
