...
---
# <a name="set-up-windows-virtual-desktop"></a>Windows 가상 데스크톱 설정
...
Windows 가상 데스크톱 설정 [가이드는](https://go.microsoft.com/fwlink/?linkid=2146236) 관리자에게 배포, 설정 지침 및 추가 리소스에 대한 계획 리소스 및 선행 구성을 제공합니다.
