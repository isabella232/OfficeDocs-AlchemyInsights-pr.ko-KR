...
ms.locfileid: "57899582"
---
# <a name="billing-or-invoice-faq"></a>대금 청구 또는 청구서 FAQ

- 신용 카드가 만료되는 경우를 포함한 여러 가지 이유로 결제가 **거절** 될 수 있습니다. 이 문제를 해결하려면 [결제 수단 세부 정보 업데이트](https://docs.microsoft.com/microsoft-365/commerce/billing-and-payments/manage-payment-methods#update-payment-method-details)를 참조하세요.
