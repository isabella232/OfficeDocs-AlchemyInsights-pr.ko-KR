...
기본적으로 모든 파일에 대한 자동 저장을 설정 또는 해제하려면 **파일** > **옵션** > *저장* 으로 이동한 다음 **기본으로 자동 저장 OneDrive 및 SharePoint 온라인 파일<application> 옆에 있는 상자를 선택 또는 선택 취소합니다**. 응용 프로그램(Excel, Word, PowerPoint 등)을 다시 시작하면 변경이 적용됩니다. 
