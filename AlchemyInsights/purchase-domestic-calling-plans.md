...
- 자세한 내용은 [전화 시스템 및 통화 플랜](https://docs.microsoft.com/MicrosoftTeams/calling-plan-landing-page)을 참조하세요.
- 플랜 및 가격을 보려면 [전화 시스템 가격](https://www.microsoft.com/microsoft-365/microsoft-teams/voice-calling#Requirements)을 참조하세요.
...
[오디오 회의 및 통화 플랜의 국가 및 지역 가용성](https://docs.microsoft.com/MicrosoftTeams/country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans)을 참조하세요. 
