...
- [보안 &amp; 에서 감사 로그를 검색 합니다. 준수 센터](https://docs.microsoft.com/microsoft-365/compliance/search-the-audit-log-in-security-and-compliance): 아직 항목을 찾을 수 없는 경우 감사 로그 (로깅이 사용 하도록 설정 된 경우)를 검색 합니다.