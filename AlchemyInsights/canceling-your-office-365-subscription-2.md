...
조직 데이터를 기반으로 모든 현재 구독에 25 개 이상의 라이선스가 할당 되었다고 생각 합니다. 25 보다 적을 때까지 사용자를 제거한 다음 **Billing** \> **[제품](https://go.microsoft.com/fwlink/p/?linkid=842054)** 청구 페이지로 이동 합니다. **& 작업 설정** 섹션에서 **구독 취소**를 선택 합니다.
