...
ms.locfileid: "47745865"
---
# <a name="renewing-your-subscription"></a>구독 갱신

신용 카드 또는 은행 계좌로 결제 하는 경우에는 기본적으로 되풀이 요금이 설정 됩니다. 대금 청구를 주기적으로 설정 하면 구독은 구독 한 날에 매년 계속 청구 됩니다. 되풀이 청구가 활성 상태인 경우 관리 센터에서 끄거나 다시 켤 수 있습니다.
