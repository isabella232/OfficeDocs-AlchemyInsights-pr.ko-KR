...
---
# <a name="verify-your-domain-with-bluehost"></a>Bluehost를 사용하여 도메인 확인
...
단계별 [지침은 Bluehost에서 Microsoft 365용](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-bluehost) DNS 레코드 만들기를 참조하세요.