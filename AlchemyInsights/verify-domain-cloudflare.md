...
---
# <a name="verify-your-domain-with-cloudflare"></a>Cloudflare를 사용하여 도메인 확인
...
단계별 [지침은 Cloudflare에서 Microsoft 365용](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-cloudflare) DNS 레코드 만들기를 참조하세요.