...
ms.locfileid: "48753713"
---
# <a name="recording-in-teams"></a>Teams에서 녹음/녹화

이제 Microsoft Teams 모임 기록을 OneDrive SharePoint에 저장할 수 있습니다. 자세한 내용과 선택 사항은 다음 메시지 센터 게시물을 참조하세요.[(업데이트됨) Microsoft Teams: OneDrive 및 SharePoint에 저장된 모임 기록](https://portal.microsoft.com/Adminportal/Home?ref=MessageCenter&id=MC222640)
