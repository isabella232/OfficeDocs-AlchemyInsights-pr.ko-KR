...
- 구독을 **다시 활성화** 하려면 [구독 다시 활성화하기](https://docs.microsoft.com/alchemyinsights/reactivate-your-subscription)를 참조하세요.
- 평가판을 **연장** 하려면 [평가판 연장](https://docs.microsoft.com/microsoft-365/commerce/extend-your-trial)을 참조하세요.
